...
$income_report_order = get_row('tbl_dashboard', array('name' => 'income_report', 'status' => 1));
$expense_report_order = get_row('tbl_dashboard', array('name' => 'expense_report', 'status' => 1));
$income_expense_order = get_row('tbl_dashboard', array('name' => 'income_expense', 'status' => 1));
$payments_report_order = get_row('tbl_dashboard', array('name' => 'payments_report', 'status' => 1));
$finance_overview_order = get_row('tbl_dashboard', array('name' => 'finance_overview', 'status' => 1));
$goal_report_order = get_row('tbl_dashboard', array('name' => 'goal_report', 'status' => 1));
?>
<!-- Morris.js charts -->
