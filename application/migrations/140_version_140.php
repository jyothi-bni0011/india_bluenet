...
class Migration_Version_140 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->db->query("INSERT INTO `tbl_config` (`config_key`, `value`) VALUES ('purchase_prefix', 'PUR');;");
        $this->db->query("INSERT INTO `tbl_config` (`config_key`, `value`) VALUES ('purchase_start_no', '1');;");
        $this->db->query("INSERT INTO `tbl_config` (`config_key`, `value`) VALUES ('return_stock_prefix', 'RSTCK');;");
