                    ...
                    <div class="step-content clearfix">
                        ...
                        if ($step == 1) { ?>
                            <div class="step-pane <?= $step1 ?>" id="step1">
                                ...
                                if (!extension_loaded('mcrypt')) {
                                    $error = TRUE;
                                    echo "<div class='alert alert-danger'>Mcrypt PHP extension missing!</div>";
                                } else {
                                    echo "<div class='alert alert-success'><i class='fa fa-check-circle'></i> Mcrypt PHP extension loaded!</div>";
                                }
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="form-control"
                                               placeholder="xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx" name="purchase_key">
                        ...
                        <?php if ($step == 4) { ?>
                            <div class="step-pane <?= $step4 ?>" id="step4">
                                ...
                                <?php echo '<input type="hidden" name="db_username" value="' . $_POST['db_username'] . '">'; ?>
                                <?php echo '<input type="hidden" name="db_password" value="' . $_POST['db_password'] . '">'; ?>
                                <?php echo '<input type="hidden" name="envato_user" value="' . $_POST['envato_user'] . '">'; ?>
                                <?php echo '<input type="hidden" name="purchase_key" value="' . $_POST['purchase_key'] . '">'; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="email" class="form-control" placeholder="admin@unique_coder.com"
                                               name="admin_email">
                                    </div>
                                </div>
